    ...
    return (
        <div className="relative z-0 w-full  group ">
            <input
                ...
                min={type == 'number' && "1"}
                disabled={disabled}
                className={`block min-w-[200px]  ${shadow ? shadow : 'shadow-[#b6b6b6]'} bg-white   py-2.5  w-full text-[12px] text-gray-900 bg-transparent  px-5 appearance-none   focus:ring-0  peer rounded-[5px] ${table ? 'focus:outline-yellow' : 'focus:outline-none border border-[#a1a1a1] '}`} />
